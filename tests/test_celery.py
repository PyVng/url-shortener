...
from tasks import log_visit, process_analytics, cleanup_old_visits
...
class TestLogVisitTask:
    ...
    def test_log_visit_success(self, mock_get_db_session, test_db):
        ...
        with patch('tasks.geoip2') as mock_geoip2, \
             patch('tasks.user_agents') as mock_ua, \
            ...
            # Execute task
            result = task_instance(url_id=url_obj.id, request_data=request_data, final_url=original_url)
    ...
    def test_log_visit_retry_on_failure(self, mock_get_db_session):
        ...
        result = task_instance(url_id=1, request_data=request_data, final_url='https://example.com')
